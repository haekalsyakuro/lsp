        ...
        <div class="detail-transaksi">
            ...
            <div class="transaksi">
                ...
                if ($transaksi["status"] == "proses") { ?>
                    <div class="aksi">
                        <a href="verif.php?id=<?= $transaksi["id_transaksi"] ?>" class="btn btn-primary">Verifikasi Transaksi</a>

                        <a href="reject.php?id=<?= $transaksi["id_transaksi"] ?>" class="btn btn-danger">Reject</a>
                    </div> <?php
